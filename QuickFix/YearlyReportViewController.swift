...
/// Report details screen for Yearly reports.
/// Same UI as Monthly, but title differs.
final class YearlyReportViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        case .technicians: return max(report.byTechnician.count, 1)
        }
    }
